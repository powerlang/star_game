...
class StarInfo(models.Model):
    ...
    avatar = models.ImageField(max_length=256, verbose_name="头像", upload_to=path_and_rename('avatar'))
    class Meta:
        app_label = "game"
        verbose_name = "明星"
...
class GroupInfo(models.Model):
    ...
    qrPic = models.ImageField(max_length=256, verbose_name="群二维码", upload_to=path_and_rename('qr'))
